          ...
          <section id="blog-details" class="blog-details section">
            <div class="container">
              ...
              <article class="article">
                ...
                <h2 class="title">Pelaksanaan Ujian Dinas & UPKP di Lingkungan KEMENDIKTI SAINTEK & KEMENTAN, serta Penyerahan Surat Tugas Pegawai</h2>

                <div class="meta-top">
                  <ul>
                    <li class="d-flex align-items-center"><i class="bi bi-folder"></i></i> <a href="berita">Berita</a></li>
                    <li class="d-flex align-items-center"><i class="bi bi-clock"></i>17, September 2025</time></a></li>
                  </ul>
                </div><!-- End meta top -->

                <div class="content">
                  <p style="text-align:justify;">
                    17 September 2025, Badan Kepegawaian Negara memfasilitasi Ujian Dinas dan Ujian Penyesuaian Ijazah di Lingkungan Kementerian Pendidikan Tinggi, Sains, dan Teknologi untuk 12 peserta dari total 13, sekaligus pelaksanaan Ujian Dinas Penyesuaian Ijazah di Lingkungan Kementerian Pertanian untuk 1 peserta. Metode CAT MST BKN digunakan pada pelaksanaan ujian tersebut dan didasarkan pada SOP yang telah ditetapkan. Kegiatan berlangsung secara lancar dan tertib.
                  </p>
