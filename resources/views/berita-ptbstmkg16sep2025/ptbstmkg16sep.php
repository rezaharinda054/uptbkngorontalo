          ...
          <section id="blog-details" class="blog-details section">
            <div class="container">
              ...
              <article class="article">
                ...
                <h2 class="title">Pelaksanaan Seleksi Lanjutan Penerimaan Taruna Baru (PTB) Sekolah Tinggi Meteorologi, Klimatologi, dan Geofisika (STMKG) TA. 2025</h2>

                <div class="meta-top">
                  <ul>
                    <li class="d-flex align-items-center"><i class="bi bi-folder"></i></i> <a href="berita">Berita</a></li>
                    <li class="d-flex align-items-center"><i class="bi bi-clock"></i>16 September 2025</time></a></li>
                  </ul>
                </div><!-- End meta top -->
                ...
                <div class="content">
                  ...
                  <p style="text-align:justify;">
                    Terdapat satu peserta dalam seleksi lanjutan STMKG untuk titik lokasi UPT BKN Gorontalo. Rangkaian Kegiatan dimulai sejak 09.00 s.d. 12.00 WITa. Durasi ujian berlangsung selama 90 menit dan skor peserta mencapai angka 230.
                  </p>

                  <p style="text-align:justify;">
                    Proses seleksi berlangsung secara lancar dan tertib serta didasarkan pada standar operasional prosedur yang berlaku.
                  </p>
