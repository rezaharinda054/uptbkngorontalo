          ...
          <section id="blog-details" class="blog-details section">
            <div class="container">
              ...
              <article class="article">
                ...
                <h2 class="title">Fasilitasi Ujian Penyesuaian Kenaikan Pangkat di Lingkungan Kemendukbangga/BKKBN & BPK di Titik Lokasi UPT BKN Gorontalo</h2>

                <div class="meta-top">
                  <ul>
                    <li class="d-flex align-items-center"><i class="bi bi-folder"></i></i> <a href="berita">Berita</a></li>
                    <li class="d-flex align-items-center"><i class="bi bi-clock"></i>10, September 2025</time></a></li>
                  </ul>
                </div><!-- End meta top -->
