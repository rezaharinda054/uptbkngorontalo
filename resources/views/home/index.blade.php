<main class="main">
      ...
      <div class="container">
        <div class="isotope-layout" data-default-filter="*" data-layout="masonry" data-sort="original-order">
          ...
          <div class="row gy-4 isotope-container" data-aos="fade-up" data-aos-delay="200">
            ...
            <div class="col-lg-4 col-md-6 portfolio-item isotope-item filter-branding filter-product">
    ...
    <section id="call-to-action" class="call-to-action section dark-background">
      ...
      <img src="assets/img/bg-survey/survey.jpg" alt="">
    ...
    <section style="background-image: url(assets/img/bg-content/bg-content.png);">
      <!-- Section Title -->
      <div class="container section-title" data-aos="fade-up">
        <h2 class="h2upt-footer">TITIK LOKASI</h2>
        ...
        <p class="h2upt-footer"><i class="bi bi-geo-alt"></i> Jl. Sultan Amay, Tamalate, Kec. Kota Timur, Kota Gorontalo, Gorontalo 96135</p>
        <p class="h2upt-footer"><strong><i class="bi bi-envelope"></i></strong> <span>uptbkngorontalo@gmail.com</span></p>
      </div><!-- End Section Title -->
